        ...
        showDropMenu = function (menu, duration = -1, shift = -1) {
            ...
            if ($menu.hasClass("bottom")) {
                if ($menu.hasClass("yt-from-left")) {
                    ...
                    anime({ targets: menuItems, translateX: [-shift, 0], duration: duration, easing: "easeOutQuad", delay: anime.stagger(duration / menuItems.length) }).complete = function () { menu.style.overflow = "visible" }
                    ...
                    anime({ targets: menuItems, translateY: [shift, 0], duration: duration, easing: "easeOutQuad", delay: anime.stagger(duration / menuItems.length) }).complete = function () { menu.style.overflow = "visible" }.complete = function () { menu.style.overflow = "visible" }
                }
                ...
                if ($menu.hasClass("yt-form-top")) {
                    ...
                    anime({ targets: menuItems, translateY: [shift, 0], duration: duration, easing: "easeOutQuad", delay: anime.stagger(duration / menuItems.length) }).complete = function () { menu.style.overflow = "visible" }
